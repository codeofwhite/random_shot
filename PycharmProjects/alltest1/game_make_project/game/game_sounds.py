...
laser_sound = pg.mixer.Sound(
    'C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/sounds/SnapInsta.io - 激光枪音效【laser gun sound】 (128 kbps).mp3')
expl_sounds = []
for i in range(2):
...
die_music = pg.mixer.Sound(
    'C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/sounds/SnapInsta.io - 游戏结束蜂鸣声（Game over beep）_ 音樂音效 （Music Sound Effects） (128 kbps).mp3')
# 吃到奖励
...
time_sound = pg.mixer.Sound('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/sounds/time_sound.mp3')
time_2_sound = pg.mixer.Sound('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/sounds/time2.mp3')
