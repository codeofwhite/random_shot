...
btn1_img = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/button_type_1.png')
btn2_img = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/button_type_1.png')
btn3_img = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/button_type_1.png')
btn4_img = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/button_type_1.png')
...
init_bg_img = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/content_img.jpg')
store_img = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/OIG.wnRZ6M1r58iBqxJV7.1b.jpg')
...
player_inv = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/player_inv.png').convert()
player_inv.set_colorkey(BLACK)
player_inv = pg.transform.scale(player_inv, (50, 38))

player_time = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/player_time.png').convert()
player_time.set_colorkey(BLACK)
player_time = pg.transform.scale(player_time, (50, 38))

player_gunup = pg.image.load('C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/player_gunup.png').convert()
...
laser_img = pg.image.load(
    'C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/OIG.Xq_pdFx8_rCRKTlbXZzh-removebg-preview.png').convert()
...
power_imgs['time'] = pg.transform.scale(pg.image.load(
    f'C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/inv_time.png'),
    (40, 40))
power_imgs['time2'] = pg.transform.scale(pg.image.load(
    'C:/Users/zhj20/PycharmProjects/alltest1/game_make_project/imgs/time2.png'),
    (40, 40))
